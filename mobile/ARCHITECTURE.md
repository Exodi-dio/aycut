...
Progress: **E1 ✅** (timebase kernel) · **E2 ✅** (source projection) · **E3 ✅** (track types + audio envelope) · **E4 ✅** (effects + keyframes + transitions + `RenderResolver`) · E5–E12 pending · M6–M8 pending.
